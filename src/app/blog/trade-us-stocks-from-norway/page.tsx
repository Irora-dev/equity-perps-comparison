...
import { translations, popularStocks, nativeLang, nativeName } from '@/data/translations/norway';
...
export default function TradeUSStocksFromNorway() {
  ...
  return (
    <div className="min-h-screen bg-gray-950">
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-red-500/20 via-gray-950 to-blue-500/20" />
        ...
        <div className="absolute top-4 right-4 z-10">
          <LanguageToggle currentLang={lang} nativeLang={nativeLang} nativeName={nativeName} onToggle={(l) => setLang(l as 'en' | 'no')} />
        </div>
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="px-3 py-1 bg-blue-500/20 text-blue-400 text-sm font-medium rounded-full">{t.noBrokerBadge}</span>
          </div>
      ...
      <section className="py-16 px-4 bg-gray-900/50">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Norway Guides Section */}
          <div className="mt-12 bg-gradient-to-r from-red-500/10 to-blue-500/10 border border-red-500/20 rounded-2xl p-6">
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-red-500/20 to-blue-500/20 border border-red-500/30 rounded-2xl p-8 text-center">
            <h2 className="text-3xl font-bold text-white mb-4">
              {t.ctaTitle}
            </h2>
