...
import { translations, popularStocks } from '@/data/translations/eu';
...
export default function TradeUSStocksFromEU() {
                ...
                <div className="px-6 pb-6 border-t border-gray-800 pt-6">
                  ...
                  <div className="grid md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div className="bg-purple-500/10 border border-purple-500/30 rounded-xl p-4">
                      <h4 className="text-purple-400 font-semibold mb-2">{t.kraken.title}</h4>
                      <p className="text-gray-400 text-sm mb-3">{t.kraken.desc}</p>
                      <ol className="text-xs text-gray-300 space-y-1">
                        {t.kraken.steps.map((step, i) => (
                    ...
                    <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-4">
                      <h4 className="text-yellow-400 font-semibold mb-2">{t.binance.title}</h4>
                      <p className="text-gray-400 text-sm mb-3">{t.binance.desc}</p>
                      <ol className="text-xs text-gray-300 space-y-1">
                        {t.binance.steps.map((step, i) => (
                          <li key={i}>{i + 1}. {step}</li>
                        ))}
                      </ol>
                    </div>
                    ...
                    <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4">
                      <h4 className="text-blue-400 font-semibold mb-2">{t.coinbase.title}</h4>
                      <p className="text-gray-400 text-sm mb-3">{t.coinbase.desc}</p>
                      <ol className="text-xs text-gray-300 space-y-1">
                        {t.coinbase.steps.map((step, i) => (
                          <li key={i}>{i + 1}. {step}</li>
                        ))}
                      </ol>
                    </div>
            ...
            {t.relatedGuides.map((guide, i) => (
              <Link key={i} href={guide.href} className="bg-gray-900 border border-gray-800 rounded-xl p-4 hover:border-blue-500/50 transition-colors">
                <span className={`text-xs font-medium ${
                  i === 0 ? 'text-blue-400' : i === 1 ? 'text-green-400' : 'text-yellow-400'
                }`}>{guide.tag}</span>
