...
export default function TradeWith15000PKRPage() {
  const [expandedFaq, setExpandedFaq] = useState<number | null>(null);

  const faqs = [
    {
      question: 'Is PKR 15,000 really enough to trade US stocks?',
      answer: 'Yes! With equity perpetuals, you can trade fractional positions. PKR 15,000 (~$50 USDC) lets you open positions in any US stock. With 5x leverage, that gives you $250 of buying power.'
    },
    {
      question: 'What stocks can I trade with PKR 15,000?',
    ...
    {
      question: 'How much can I make with PKR 15,000?',
      answer: 'Returns depend on your trading skill and risk management. A 10% gain on $50 is $5 (PKR 1,500). With 5x leverage, that same 10% stock move becomes 50% on your capital - potentially PKR 7,500. But losses are amplified too.'
    },
    {
      question: 'How do I convert PKR to USDC?',
      answer: 'Use Binance P2P or KuCoin P2P with JazzCash, Easypaisa, or bank transfer. See our complete guide for step-by-step instructions with the best rates.'
    },
    {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f]">
      ...
      <section className="relative py-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-green-900/30 via-emerald-900/20 to-[#0a0a0f]" />
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-500/10 border border-green-500/20 rounded-full text-green-400 text-sm mb-6">
            🇵🇰 Small Account Guide for Pakistan
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/"
              className="px-8 py-4 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-xl font-bold text-lg hover:shadow-lg hover:shadow-green-500/25 transition-all"
            >
              Compare Platforms
            </Link>
            <Link
      ...
      {/* Why PKR 15,000 Works */}
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-white mb-8 text-center">
            Why PKR 15,000 is Enough
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 rounded-2xl p-6">
              ...
              <p className="text-gray-400">
                Trade 0.01 shares of any stock. NVDA at $140? You can buy $5 worth.
            ...
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 rounded-2xl p-6">
              ...
              <p className="text-gray-400">
                Use 2-5x leverage to increase buying power. PKR 15,000 becomes
                PKR 75,000 of trading power at 5x.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 rounded-2xl p-6">
              ...
              <p className="text-gray-400">
                Unlike traditional brokers requiring $25,000, equity perps
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-transparent via-green-900/5 to-transparent">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-white mb-8 text-center">
            The Math: PKR 15,000 Trading Power
          </h2>
          ...
          <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 rounded-2xl p-8">
            <div className="space-y-6">
              <div className="flex justify-between items-center py-4 border-b border-gray-700">
                ...
                <span className="text-2xl font-bold text-white">PKR 15,000 (~$50)</span>
              </div>

              <div className="flex justify-between items-center py-4 border-b border-gray-700">
                <span className="text-gray-400">At 2x Leverage</span>
                <span className="text-xl font-semibold text-green-400">$100 buying power</span>
              </div>

              <div className="flex justify-between items-center py-4 border-b border-gray-700">
                <span className="text-gray-400">At 5x Leverage</span>
                <span className="text-xl font-semibold text-green-400">$250 buying power</span>
              </div>

              <div className="flex justify-between items-center py-4">
                <span className="text-gray-400">At 10x Leverage</span>
                <span className="text-xl font-semibold text-emerald-400">$500 buying power</span>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="flex gap-6 items-start">
              <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-green-500 to-emerald-500 rounded-xl flex items-center justify-center text-white font-bold text-xl">
                1
              </div>
              <div className="flex-1">
                <h3 className="text-xl font-bold text-white mb-2">Convert PKR to USDC</h3>
                <p className="text-gray-400 mb-3">
                  Use Binance P2P or KuCoin P2P with JazzCash or Easypaisa. PKR 15,000 gets you
            ...
            <div className="flex gap-6 items-start">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-400">
                  ...
                  on Arbitrum, Base, or their native chain. Gas fees are minimal (under $1).
                </p>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-green-900/20 to-green-800/10 border border-green-500/20 rounded-2xl p-6">
              <h3 className="text-xl font-bold text-green-400 mb-4">✅ Do This</h3>
          ...
          <div className="mt-12 bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/20 rounded-2xl p-6">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <div>
                  <p className="font-medium text-white">Trade US Stocks from Pakistan</p>
              ...
              >
                <span className="text-2xl">💱</span>
                <div>
                  <p className="font-medium text-white">Convert PKR to USDC</p>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-green-900/30 to-emerald-900/30 border border-green-500/20 rounded-3xl p-8 md:p-12 text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Ready to Start Trading?
            </h2>
            <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
              Compare platforms, get your USDC, and start trading US stocks
              with your PKR 15,000 today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/"
