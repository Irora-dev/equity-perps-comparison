...
import { translations, popularStocks, nativeLang, nativeName } from '@/data/translations/senegal';
...
export default function TradeUSStocksFromSenegal() {
    ...
    <div className="min-h-screen bg-gray-950">
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="absolute top-4 right-4 z-10">
          <LanguageToggle currentLang={lang} nativeLang={nativeLang} nativeName={nativeName} onToggle={(l) => setLang(l as 'en' | 'fr')} />
        </div>
                ...
                <div className="px-6 pb-6 border-t border-gray-800 pt-6">
                  ...
                  <div className="grid md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div className="bg-orange-500/10 border border-orange-500/30 rounded-xl p-4">
                      <h4 className="text-orange-400 font-semibold mb-2">{t.binanceP2P.title}</h4>
            ...
            {t.relatedGuides.map((guide, i) => (
              <Link key={i} href={guide.href} className="bg-gray-900 border border-gray-800 rounded-xl p-4 hover:border-green-500/50 transition-colors">
                <span className={`text-xs font-medium ${
                  i === 0 ? 'text-green-400' : i === 1 ? 'text-yellow-400' : 'text-orange-400'
                }`}>{guide.tag}</span>
