    ...
    <div className="min-h-screen bg-[#0a0a0f]">
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-500/10 border border-green-500/20 rounded-full text-green-400 text-sm mb-6">🇸🇳 Guide for Senegalese Traders</div>
          <h1 className="text-4xl md:text-6xl font-bold mb-6"><span className="text-white">Trade US Stocks</span><br /><span className="bg-gradient-to-r from-green-400 via-yellow-400 to-red-400 bg-clip-text text-transparent">from Senegal</span></h1>
          <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">Access NVIDIA, Tesla, Apple with XOF. Start with 30,000 CFA. Trade 24/7 with Wave or Orange Money.</p>
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-6">
          {[{icon:'💰',title:'Start with 30K CFA',desc:'~$50 USDC minimum'},{icon:'🕐',title:'24/7 Trading',desc:'Trade anytime GMT'},{icon:'📱',title:'Wave & Orange',desc:'Popular mobile money'},{icon:'🔐',title:'Self-Custody',desc:'Your keys, your coins'}].map((b,i)=>(
      ...
      <section id="get-started" className="py-16 px-4 bg-gradient-to-b from-transparent via-green-900/5 to-transparent">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            {[{t:'Convert XOF to USDC',d:'Use Binance P2P with Wave or Orange Money.'},{t:'Choose a Platform',d:'Compare platforms.',l:'/',lt:'Compare'},{t:'Connect Wallet',d:'Use MetaMask or Rabby.'},{t:'Start Trading',d:'Begin with 2-3x leverage.'}].map((s,i)=>(
