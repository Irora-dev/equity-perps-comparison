...
import { translations, popularStocks, nativeLang, nativeName, isRTL } from '@/data/translations/kenya';
...
export default function TradeUSStocksFromKenya() {
  ...
  return (
    <div className="min-h-screen bg-gray-950">
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-black/80 via-gray-950 to-green-500/20" />
                ...
                <div className="px-6 pb-6 border-t border-gray-800 pt-6">
                  ...
                  <div className="grid md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-4">
                      <h4 className="text-red-400 font-semibold mb-2">{t.wazirx.title}</h4>
                    ...
                    <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4">
                      <h4 className="text-blue-400 font-semibold mb-2">{t.coindcx.title}</h4>
      ...
      <section className="py-16 px-4 bg-gray-900/50">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Kenya Guides Section */}
          <div className="mt-12 bg-gradient-to-r from-green-500/10 to-red-500/10 border border-green-500/20 rounded-2xl p-6">
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-green-500/20 to-red-500/20 border border-green-500/30 rounded-2xl p-8 text-center">
            <h2 className="text-3xl font-bold text-white mb-4">
              {t.ctaTitle}
            </h2>
            ...
            {t.relatedGuides.map((guide, i) => (
              <Link key={i} href={guide.href} className="bg-gray-900 border border-gray-800 rounded-xl p-4 hover:border-green-500/50 transition-colors">
                <span className={`text-xs font-medium ${
                  i === 0 ? 'text-green-400' : i === 1 ? 'text-red-400' : 'text-yellow-400'
                }`}>{guide.tag}</span>
