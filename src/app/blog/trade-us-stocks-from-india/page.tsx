  ...
  return (
    <div className="min-h-screen bg-gray-950">
      ...
      <section className="relative pt-16 sm:pt-20 pb-12 sm:pb-20 px-4 overflow-hidden">
        ...
        <div className="absolute top-20 left-10 w-48 sm:w-72 h-48 sm:h-72 bg-orange-500/10 rounded-full blur-3xl" />
        <div className="absolute bottom-20 right-10 w-48 sm:w-72 h-48 sm:h-72 bg-green-500/10 rounded-full blur-3xl" />
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <div className="flex flex-wrap items-center gap-2 mb-4 sm:mb-6">
            <span className="px-2 sm:px-3 py-1 bg-orange-500/20 text-orange-400 text-xs sm:text-sm font-medium rounded-full">🇮🇳 {t.badge}</span>
            <span className="px-2 sm:px-3 py-1 bg-green-500/20 text-green-400 text-xs sm:text-sm font-medium rounded-full">{t.noBrokerBadge}</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-8 sm:mb-12">
            <a
              href="#get-started"
              className="w-full sm:w-auto text-center px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-xl font-bold text-base sm:text-lg hover:from-orange-400 hover:to-orange-500 transition-all shadow-lg shadow-orange-500/25"
            >
              {t.startTrading}
            </a>
            <a
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            <span className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-orange-500/10 border border-orange-500/30 rounded-full mb-3 sm:mb-4">
              <span className="text-orange-400 font-medium text-sm sm:text-base">{t.stepByStep}</span>
            </span>
          ...
          <div className="mb-4 sm:mb-6">
            ...
            >
              <div className="p-4 sm:p-6 flex items-center gap-3 sm:gap-6">
                <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center text-white font-black text-xl sm:text-2xl flex-shrink-0">
                  2
                </div>
                <div className="flex-grow min-w-0">
                ...
                <svg
                  className={`w-5 h-5 sm:w-6 sm:h-6 text-orange-400 transition-transform flex-shrink-0 ${fundingExpanded ? 'rotate-180' : ''}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <div className="px-4 sm:px-6 pb-4 sm:pb-6 border-t border-gray-800 pt-4 sm:pt-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 mb-4 sm:mb-6">
                    ...
                    <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-3 sm:p-4">
                      <h4 className="text-blue-400 font-semibold mb-2 text-sm sm:text-base">{t.wazirx.title}</h4>
                    ...
                    <div className="bg-purple-500/10 border border-purple-500/30 rounded-xl p-3 sm:p-4">
                      <h4 className="text-purple-400 font-semibold mb-2 text-sm sm:text-base">{t.coindcx.title}</h4>
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-2 mt-3 sm:mt-4 text-orange-400 hover:text-orange-300 font-medium text-sm sm:text-base"
                  >
                    {t.seeDetailedGuide}
          ...
          <div className="bg-gray-900 border-2 border-green-500/30 rounded-2xl p-4 sm:p-6">
            <div className="flex items-center gap-3 sm:gap-6 mb-4 sm:mb-6">
              <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center text-gray-900 font-black text-xl sm:text-2xl flex-shrink-0">
                3
              </div>
              <div>
            ...
            <ol className="space-y-2 sm:space-y-3 text-gray-300 mb-4 sm:mb-6">
              <li className="flex gap-2 sm:gap-3">
                ...
                <span className="text-xs sm:text-sm">{t.tradeSteps[0].text} <button onClick={() => hyperliquid?.referralUrl && trackHyperliquidClick(hyperliquid.referralUrl)} className="text-green-400 hover:text-green-300 underline">{t.tradeSteps[0].linkText}</button></span>
              </li>
              <li className="flex gap-2 sm:gap-3">
      ...
      <section className="py-12 sm:py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
            {popularStocks.map(stock => (
              <Link
                ...
                className="bg-gray-900 border border-gray-800 rounded-xl p-3 sm:p-4 hover:border-orange-500/50 transition-colors"
              >
                <div className="flex items-center justify-between mb-1 sm:mb-2">
                  <span className="text-white font-bold text-sm sm:text-base">{stock.ticker}</span>
                  {stock.hot && <span className="text-[10px] sm:text-xs bg-orange-500/20 text-orange-400 px-1.5 sm:px-2 py-0.5 rounded-full">{t.hot}</span>}
                </div>
          ...
          <div className="text-center mt-4 sm:mt-6">
            <Link href="/stocks" className="text-orange-400 hover:text-orange-300 font-medium text-sm sm:text-base">
              {t.viewAllStocks}
            </Link>
          </div>
        </div>
      ...
      <section className="py-12 sm:py-16 px-4 bg-gray-900/50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-8 sm:mt-12 bg-gradient-to-r from-orange-500/10 to-green-500/10 border border-orange-500/20 rounded-2xl p-4 sm:p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              {t.guides.map((guide, i) => (
                <Link
                  key={i}
                  href={guide.href}
                  className="flex items-center gap-3 bg-gray-900/80 border border-gray-800 rounded-xl p-3 sm:p-4 hover:border-orange-500/50 transition-colors"
                >
      ...
      <section className="py-12 sm:py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-orange-500/20 to-green-500/20 border border-orange-500/30 rounded-2xl p-5 sm:p-8 text-center">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3 sm:mb-4">
              {t.ctaTitle}
            </h2>
            ...
            <button
              onClick={() => hyperliquid?.referralUrl && trackHyperliquidClick(hyperliquid.referralUrl)}
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-xl font-bold text-base sm:text-lg hover:from-orange-400 hover:to-orange-500 transition-all shadow-lg shadow-orange-500/25 cursor-pointer"
            >
              {t.getStartedCta}
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
            {t.relatedGuides.map((guide, i) => (
              <Link key={i} href={guide.href} className="bg-gray-900 border border-gray-800 rounded-xl p-3 sm:p-4 hover:border-orange-500/50 transition-colors">
