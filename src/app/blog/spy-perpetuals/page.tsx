...
const stock = getStockBySlug('spy-perpetuals')!;

export const metadata: Metadata = {
  title: `${stock.ticker} Perpetuals: Trade ${stock.name} 24/7 with Leverage`,
  description: `Complete guide to trading ${stock.ticker} perpetual futures. Compare platforms, fees, funding rates, and liquidity for S&P 500 ETF perps.`,
  openGraph: {
    title: `${stock.ticker} Perpetuals Trading Guide`,
    description: `Trade ${stock.name} around the clock with leverage on decentralized platforms.`,
  },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: `${stock.ticker} Perpetuals: Trade ${stock.name} 24/7 with Leverage`,
