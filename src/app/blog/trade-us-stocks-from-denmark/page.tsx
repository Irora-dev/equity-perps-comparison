...
import { translations, popularStocks, nativeLang, nativeName } from '@/data/translations/denmark';
...
export default function TradeUSStocksFromDenmark() {
    ...
    <div className="min-h-screen bg-gray-950">
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="absolute top-4 right-4 z-10">
          <LanguageToggle currentLang={lang} nativeLang={nativeLang} nativeName={nativeName} onToggle={(l) => setLang(l as 'en' | 'da')} />
        </div>
      ...
      {/* Why This Works for Danish Traders */}
                ...
                <div className="px-6 pb-6 border-t border-gray-800 pt-6">
                  ...
                  <div className="grid md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4">
                      <h4 className="text-blue-400 font-semibold mb-2">{t.moonpay.title}</h4>
                      <p className="text-gray-400 text-sm mb-3">{t.moonpay.desc}</p>
                      <ol className="text-xs text-gray-300 space-y-1">
                        {t.moonpay.steps.map((step, i) => (
                          <li key={i}>{i + 1}. {step}</li>
                        ))}
                      </ol>
                    </div>
