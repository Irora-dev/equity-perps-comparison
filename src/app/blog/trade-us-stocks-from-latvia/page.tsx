...
import { translations, popularStocks, nativeLang, nativeName, isRTL } from '@/data/translations/latvia';
...
export default function TradeUSStocksFromLatvia() {
  ...
  return (
    <div className="min-h-screen bg-gray-950">
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-red-900/20 via-gray-950 to-white/10" />
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <div className="flex items-center gap-2 mb-6">
            <span className="px-3 py-1 bg-red-900/20 text-red-400 text-sm font-medium rounded-full">🇱🇻 {t.badge}</span>
          ...
          <div className="flex flex-wrap gap-4 mb-12">
            <a
              href="#get-started"
              className="px-8 py-4 bg-gradient-to-r from-red-800 to-red-900 text-white rounded-xl font-bold text-lg hover:from-red-700 hover:to-red-800 transition-all shadow-lg shadow-red-900/25"
            >
              {t.startTrading}
            </a>
            <a
      ...
      <section id="get-started" className="py-16 px-4 bg-gray-900/50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-red-900/10 border border-red-900/30 rounded-full mb-4">
          ...
          {/* Step 2: Fund with EUR */}
          <div className="mb-6">
            <div
              className="bg-gray-900 border-2 border-red-900/30 rounded-2xl overflow-hidden cursor-pointer hover:border-red-900/50 transition-colors"
              onClick={() => setFundingExpanded(!fundingExpanded)}
            >
              <div className="p-6 flex items-center gap-6">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-red-800 to-red-900 flex items-center justify-center text-white font-black text-2xl flex-shrink-0">
                  2
                </div>
                <div className="flex-grow">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {popularStocks.map(stock => (
              <Link
                ...
                className="bg-gray-900 border border-gray-800 rounded-xl p-4 hover:border-red-900/50 transition-colors"
              >
                <div className="flex items-center justify-between mb-2">
                  <span className="text-white font-bold">{stock.ticker}</span>
                  {stock.hot && <span className="text-xs bg-red-900/20 text-red-400 px-2 py-0.5 rounded-full">{t.hot}</span>}
                </div>
      ...
      <section className="py-16 px-4 bg-gray-900/50">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Latvia Guides Section */}
          <div className="mt-12 bg-gradient-to-r from-red-900/10 to-white/5 border border-red-900/20 rounded-2xl p-6">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {t.guides.map((guide, i) => (
                <Link
                  key={i}
                  href={guide.href}
                  className="flex items-center gap-3 bg-gray-900/80 border border-gray-800 rounded-xl p-4 hover:border-red-900/50 transition-colors"
                >
                  <div className={`w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 ${
                    i === 0 ? 'bg-red-900/20 text-red-400' :
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-red-900/20 to-white/5 border border-red-900/30 rounded-2xl p-8 text-center">
            <h2 className="text-3xl font-bold text-white mb-4">
              {t.ctaTitle}
            </h2>
            ...
            <button
              onClick={() => hyperliquid?.referralUrl && trackHyperliquidClick(hyperliquid.referralUrl)}
              className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-red-800 to-red-900 text-white rounded-xl font-bold text-lg hover:from-red-700 hover:to-red-800 transition-all shadow-lg shadow-red-900/25 cursor-pointer"
            >
              {t.getStartedCta}
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {t.relatedGuides.map((guide, i) => (
              <Link key={i} href={guide.href} className="bg-gray-900 border border-gray-800 rounded-xl p-4 hover:border-red-900/50 transition-colors">
