...
import { translations, popularStocks, nativeLang, nativeName } from '@/data/translations/ethiopia';
...
export default function TradeUSStocksFromEthiopia() {
  ...
  return (
    <div className="min-h-screen bg-gray-950">
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-green-500/20 via-yellow-500/10 to-red-500/20" />
        ...
        <div className="absolute top-4 right-4 z-10">
          <LanguageToggle currentLang={lang} nativeLang={nativeLang} nativeName={nativeName} onToggle={(l) => setLang(l as 'en' | 'am')} />
        </div>
      ...
      <section id="get-started" className="py-16 px-4 bg-gray-900/50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-6">
            ...
            >
              <div className="p-6 flex items-center gap-6">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-yellow-500 to-yellow-600 flex items-center justify-center text-white font-black text-2xl flex-shrink-0">
                  2
                </div>
                <div className="flex-grow">
      ...
      <section className="py-16 px-4 bg-gray-900/50">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Ethiopia Guides Section */}
          <div className="mt-12 bg-gradient-to-r from-green-500/10 via-yellow-500/10 to-red-500/10 border border-green-500/20 rounded-2xl p-6">
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-green-500/20 via-yellow-500/10 to-red-500/20 border border-green-500/30 rounded-2xl p-8 text-center">
            <h2 className="text-3xl font-bold text-white mb-4">
              {t.ctaTitle}
            </h2>
