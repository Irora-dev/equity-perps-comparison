...
import { translations, digitalPayments, banksList, nativeLang, nativeName, isRTL } from '@/data/translations/egypt';
...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f]" dir={lang === 'ar' && isRTL ? 'rtl' : 'ltr'}>
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6"><span className="text-white">{t.heroTitle1}</span><br /><span className="bg-gradient-to-r from-red-400 to-yellow-400 bg-clip-text text-transparent">{t.heroTitle2}</span></h1>
          <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">{t.heroDesc}</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/" className="px-8 py-4 bg-gradient-to-r from-red-500 to-yellow-600 text-white rounded-xl font-bold text-lg hover:shadow-lg transition-all">{t.comparePlatforms}</Link>
      ...
      <section className="py-16 px-4"><div className="max-w-4xl mx-auto"><div className="bg-gradient-to-r from-red-900/30 to-yellow-900/30 border border-red-500/20 rounded-3xl p-8 text-center"><h2 className="text-3xl font-bold text-white mb-4">{t.ctaTitle}</h2><p className="text-xl text-gray-400 mb-8">{t.ctaDesc}</p><Link href="/" className="px-8 py-4 bg-gradient-to-r from-red-500 to-yellow-600 text-white rounded-xl font-bold text-lg">{t.comparePlatforms}</Link></div></div></section>
