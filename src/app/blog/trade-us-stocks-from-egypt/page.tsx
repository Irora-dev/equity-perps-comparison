...
import { translations, popularStocks, nativeLang, nativeName, isRTL } from '@/data/translations/egypt';
...
export default function TradeUSStocksFromEgypt() {
  ...
  return (
    <div className="min-h-screen bg-gray-950" dir={lang === 'ar' && isRTL ? 'rtl' : 'ltr'}>
      {/* Hero */}
      <section className="relative pt-16 sm:pt-20 pb-12 sm:pb-16 px-4 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-red-500/20 via-gray-950 to-gray-900/20" />
                ...
                <div className="px-6 pb-6 border-t border-gray-800 pt-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                    ...
                    <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4">
                      <h4 className="text-blue-400 font-semibold mb-2">{t.fawry.title}</h4>
                      <p className="text-gray-400 text-sm mb-3">{t.fawry.desc}</p>
                      <ol className="text-xs text-gray-300 space-y-1">
                        {t.fawry.steps.map((step, i) => (
                          <li key={i}>{i + 1}. {step}</li>
                        ))}
                      </ol>
                    </div>
                    ...
                    <div className="bg-purple-500/10 border border-purple-500/30 rounded-xl p-4">
                      <h4 className="text-purple-400 font-semibold mb-2">{t.instapay.title}</h4>
                      <p className="text-gray-400 text-sm mb-3">{t.instapay.desc}</p>
                      <ol className="text-xs text-gray-300 space-y-1">
                        {t.instapay.steps.map((step, i) => (
                          <li key={i}>{i + 1}. {step}</li>
                        ))}
                      </ol>
                    </div>
      ...
      <section className="py-12 sm:py-16 px-4 bg-gray-900/50">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Egypt Guides Section */}
          <div className="mt-12 bg-gradient-to-r from-red-500/10 to-gray-900/10 border border-red-500/20 rounded-2xl p-6">
      ...
      <section className="py-12 sm:py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-red-500/20 to-gray-900/20 border border-red-500/30 rounded-2xl p-6 sm:p-8 text-center">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">
              {t.ctaTitle}
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {t.relatedGuides.map((guide, i) => (
              <Link key={i} href={guide.href} className="bg-gray-900 border border-gray-800 rounded-xl p-4 hover:border-red-500/50 transition-colors">
                ...
                <h3 className="text-sm sm:text-base text-white font-medium mt-1">{guide.title}</h3>
