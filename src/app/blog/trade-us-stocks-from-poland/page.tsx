...
import { translations, popularStocks, nativeLang, nativeName } from '@/data/translations/poland';
...
export default function TradeUSStocksFromPoland() {
