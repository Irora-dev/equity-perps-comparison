    ...
    <div className="min-h-screen bg-[#0a0a0f]">
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-red-500/10 border border-red-500/20 rounded-full text-red-400 text-sm mb-6">🇵🇱 Guide for Polish Traders</div>
          <h1 className="text-4xl md:text-6xl font-bold mb-6"><span className="text-white">Trade US Stocks</span><br /><span className="bg-gradient-to-r from-red-400 to-white bg-clip-text text-transparent">from Poland</span></h1>
          <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">Access NVIDIA, Tesla, Apple with PLN. Start with 200 zł. Trade 24/7 with BLIK.</p>
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-6">
          {[{icon:'💰',title:'Start with 200 zł',desc:'~$50 USDC minimum'},{icon:'🕐',title:'24/7 Trading',desc:'Trade anytime CET'},{icon:'📱',title:'BLIK Ready',desc:'Instant payments'},{icon:'🔐',title:'Self-Custody',desc:'Your keys, your coins'}].map((b,i)=>(
      ...
      <section id="get-started" className="py-16 px-4 bg-gradient-to-b from-transparent via-red-900/5 to-transparent">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            {[{t:'Convert PLN to USDC',d:'Use Binance P2P with BLIK or bank transfer.'},{t:'Choose a Platform',d:'Compare platforms.',l:'/',lt:'Compare'},{t:'Connect Wallet',d:'Use MetaMask or Rabby.'},{t:'Start Trading',d:'Begin with 2-3x leverage.'}].map((s,i)=>(
