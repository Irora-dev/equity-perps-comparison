...
import { translations, popularStocks, nativeLang, nativeName } from '@/data/translations/indonesia';
...
export default function TradeUSStocksFromIndonesia() {
    ...
    <div className="min-h-screen bg-gray-950">
      ...
      <section className="relative pt-16 pb-12 sm:py-20 px-4 overflow-hidden">
        ...
        <div className="absolute top-3 right-3 sm:top-4 sm:right-4 z-10">
          <LanguageToggle currentLang={lang} nativeLang={nativeLang} nativeName={nativeName} onToggle={(l) => setLang(l as 'en' | 'id')} />
        </div>
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <div className="flex flex-wrap items-center gap-2 mb-4 sm:mb-6">
            <span className="px-2 sm:px-3 py-1 bg-red-500/20 text-red-400 text-xs sm:text-sm font-medium rounded-full">{t.badge}</span>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-8 sm:mb-12">
            <a
              href="#get-started"
              className="w-full sm:w-auto text-center px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl font-bold text-base sm:text-lg hover:from-red-400 hover:to-red-500 transition-all shadow-lg shadow-red-500/25"
            >
              {t.startTrading}
            </a>
            <a
      ...
      {/* Why This Works for Indonesians */}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            <span className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-red-500/10 border border-red-500/30 rounded-full mb-3 sm:mb-4">
              <span className="text-red-400 font-medium text-sm sm:text-base">{t.stepByStep}</span>
            </span>
                ...
                <div className="px-4 sm:px-6 pb-4 sm:pb-6 border-t border-gray-800 pt-4 sm:pt-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                      ...
                      <ol className="space-y-3 text-sm sm:text-base text-gray-300">
          ...
          <div className="mb-4 sm:mb-6">
            ...
            >
              <div className="p-4 sm:p-6 flex items-center gap-3 sm:gap-6">
                ...
                <svg
                  className={`w-5 h-5 sm:w-6 sm:h-6 text-red-400 transition-transform flex-shrink-0 ${fundingExpanded ? 'rotate-180' : ''}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <div className="px-4 sm:px-6 pb-4 sm:pb-6 border-t border-gray-800 pt-4 sm:pt-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 mb-4 sm:mb-6">
                    ...
                    <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-3 sm:p-4">
                      <h4 className="text-blue-400 font-semibold mb-2 text-sm sm:text-base">{t.indodax.title}</h4>
                      <p className="text-gray-400 text-xs sm:text-sm mb-2 sm:mb-3">{t.indodax.desc}</p>
                      <ol className="text-xs text-gray-300 space-y-1">
                        {t.indodax.steps.map((step, i) => (
                          <li key={i}>{i + 1}. {step}</li>
                        ))}
                      </ol>
                    </div>
                    ...
                    <div className="bg-purple-500/10 border border-purple-500/30 rounded-xl p-3 sm:p-4">
                      <h4 className="text-purple-400 font-semibold mb-2 text-sm sm:text-base">{t.tokocrypto.title}</h4>
                      <p className="text-gray-400 text-xs sm:text-sm mb-2 sm:mb-3">{t.tokocrypto.desc}</p>
                      <ol className="text-xs text-gray-300 space-y-1">
                        {t.tokocrypto.steps.map((step, i) => (
                  ...
                  <Link
                    href="/blog/convert-idr-to-usdc"
                    className="inline-flex items-center gap-2 mt-3 sm:mt-4 text-red-400 hover:text-red-300 font-medium text-sm sm:text-base"
                  >
                    {t.seeDetailedGuide}
          ...
          <div className="bg-gray-900 border-2 border-green-500/30 rounded-2xl p-4 sm:p-6">
            ...
            <ol className="space-y-3 text-sm sm:text-base text-gray-300 mb-4 sm:mb-6">
              <li className="flex gap-2 sm:gap-3">
            ...
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-3 bg-green-500 text-gray-900 rounded-xl font-bold hover:bg-green-400 transition-colors cursor-pointer text-sm sm:text-base"
            >
              {t.openHyperliquid}
      ...
      <section className="py-12 sm:py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
            {popularStocks.map(stock => (
              <Link
                ...
                className="bg-gray-900 border border-gray-800 rounded-xl p-3 sm:p-4 hover:border-red-500/50 transition-colors"
              >
                <div className="flex items-center justify-between mb-1 sm:mb-2">
                  <span className="text-white font-bold text-sm sm:text-base">{stock.ticker}</span>
                  {stock.hot && <span className="text-xs bg-red-500/20 text-red-400 px-1.5 sm:px-2 py-0.5 rounded-full">{t.hot}</span>}
                </div>
          ...
          <div className="text-center mt-4 sm:mt-6">
            <Link href="/stocks" className="text-red-400 hover:text-red-300 font-medium text-sm sm:text-base">
              {t.viewAllStocks} →
            </Link>
          </div>
        </div>
      ...
      <section className="py-12 sm:py-16 px-4 bg-gray-900/50">
        <div className="max-w-4xl mx-auto">
            ...
            {t.faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  ...
                  <svg
                    className={`w-4 h-4 sm:w-5 sm:h-5 text-red-400 flex-shrink-0 transition-transform ${expandedFaq === index ? 'rotate-180' : ''}`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
          ...
          {/* Indonesia Guides Section */}
          <div className="mt-8 sm:mt-12 bg-gradient-to-r from-red-500/10 to-white/5 border border-red-500/20 rounded-2xl p-4 sm:p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              {t.guides.map((guide, i) => (
                <Link
                  key={i}
                  href={guide.href}
                  className="flex items-center gap-3 bg-gray-900/80 border border-gray-800 rounded-xl p-3 sm:p-4 hover:border-red-500/50 transition-colors"
                >
      ...
      <section className="py-12 sm:py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-red-500/20 to-white/5 border border-red-500/30 rounded-2xl p-5 sm:p-8 text-center">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3 sm:mb-4">
              {t.ctaTitle}
            </h2>
            ...
            <button
              onClick={() => hyperliquid?.referralUrl && trackHyperliquidClick(hyperliquid.referralUrl)}
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl font-bold text-base sm:text-lg hover:from-red-400 hover:to-red-500 transition-all shadow-lg shadow-red-500/25 cursor-pointer"
            >
              {t.getStartedCta}
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
            {t.relatedGuides.map((guide, i) => (
              <Link key={i} href={guide.href} className="bg-gray-900 border border-gray-800 rounded-xl p-3 sm:p-4 hover:border-red-500/50 transition-colors">
                <span className={`text-xs font-medium ${
                  i === 0 ? 'text-red-400' : i === 1 ? 'text-green-400' : 'text-yellow-400'
                }`}>{guide.tag}</span>
