    ...
    <div className="min-h-screen bg-gray-950">
                ...
                <div className="px-6 pb-6 border-t border-gray-800 pt-6">
                  ...
                  <div className="grid md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4">
                      <h4 className="text-blue-400 font-semibold mb-2">{t.indodax.title}</h4>
                      <p className="text-gray-400 text-sm mb-3">{t.indodax.desc}</p>
                      <ol className="text-xs text-gray-300 space-y-1">
                    ...
                    <div className="bg-purple-500/10 border border-purple-500/30 rounded-xl p-4">
                      <h4 className="text-purple-400 font-semibold mb-2">{t.tokocrypto.title}</h4>
                      <p className="text-gray-400 text-sm mb-3">{t.tokocrypto.desc}</p>
                      <ol className="text-xs text-gray-300 space-y-1">
      ...
      <section className="py-16 px-4 bg-gray-900/50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 bg-gradient-to-r from-red-500/10 to-white/5 border border-red-500/20 rounded-2xl p-6">
