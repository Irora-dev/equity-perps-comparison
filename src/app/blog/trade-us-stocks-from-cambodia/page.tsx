...
import { translations, digitalPayments, banksList, nativeLang, nativeName } from '@/data/translations/cambodia';
    ...
    <div className="min-h-screen bg-[#0a0a0f]">
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="absolute top-4 right-4 z-10">
          <LanguageToggle currentLang={lang} nativeLang={nativeLang} nativeName={nativeName} onToggle={(l) => setLang(l as 'en' | 'km')} />
        </div>
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6"><span className="text-white">{t.heroTitle1}</span><br /><span className="bg-gradient-to-r from-blue-400 to-red-400 bg-clip-text text-transparent">{t.heroTitle2}</span></h1>
