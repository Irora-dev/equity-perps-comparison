...
import { translations, popularStocks } from '@/data/translations/south-africa';
...
export default function TradeUSStocksFromSouthAfrica() {
  ...
  return (
    <div className="min-h-screen bg-gray-950">
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-green-500/20 via-gray-950 to-red-500/20" />
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white mb-6 leading-tight">
            {t.heroTitle1}
            <br />
            <span className="bg-gradient-to-r from-green-400 via-yellow-400 to-red-400 bg-clip-text text-transparent">{t.heroTitle2}</span>
          </h1>
                ...
                <div className="px-6 pb-6 border-t border-gray-800 pt-6">
                  ...
                  <div className="grid md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4">
                      <h4 className="text-blue-400 font-semibold mb-2">{t.luno.title}</h4>
                      <p className="text-gray-400 text-sm mb-3">{t.luno.desc}</p>
                      <ol className="text-xs text-gray-300 space-y-1">
                        {t.luno.steps.map((step, i) => (
                    ...
                    <div className="bg-purple-500/10 border border-purple-500/30 rounded-xl p-4">
                      <h4 className="text-purple-400 font-semibold mb-2">{t.valr.title}</h4>
                      <p className="text-gray-400 text-sm mb-3">{t.valr.desc}</p>
                      <ol className="text-xs text-gray-300 space-y-1">
                        {t.valr.steps.map((step, i) => (
                          <li key={i}>{i + 1}. {step}</li>
                        ))}
                      </ol>
                    </div>
              ...
              {t.guides.map((guide, i) => (
                ...
                >
                  <div className={`w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 ${
                    ...
                    i === 2 ? 'bg-red-500/20 text-red-400' :
