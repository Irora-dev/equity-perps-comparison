        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            <span className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-amber-500/10 border border-amber-500/30 rounded-full mb-3 sm:mb-4">
              <span className="text-amber-400 font-medium text-sm sm:text-base">Step-by-Step</span>
            </span>
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3 sm:mb-4">
              How to Start Trading POKE
            </h2>
            <p className="text-sm sm:text-base text-gray-400 max-w-xl mx-auto">
              Get started in about 15 minutes with these four simple steps.
            </p>
          </div>
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="bg-gray-900 border-2 border-yellow-500/30 rounded-2xl p-4 sm:p-6">
              <div className="flex items-start gap-3 sm:gap-6">
                ...
                <div>
                  <h3 className="text-base sm:text-xl font-bold text-white mb-1 sm:mb-2">Get a Crypto Wallet</h3>
                  <p className="text-sm sm:text-base text-gray-400 mb-3">
                    Download a wallet like <a href="https://rabby.io" target="_blank" rel="noopener noreferrer" className="text-yellow-400 hover:text-yellow-300 underline">Rabby</a> or MetaMask. This is your key to accessing decentralized exchanges - no account creation needed.
                  </p>
                  <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-3">
                    <p className="text-xs sm:text-sm text-gray-300">
                      <strong className="text-white">Important:</strong> Write down your seed phrase and store it safely offline. This is the only way to recover your wallet.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gray-900 border-2 border-yellow-500/30 rounded-2xl p-4 sm:p-6">
              <div className="flex items-start gap-3 sm:gap-6">
                ...
                <div>
                  <h3 className="text-base sm:text-xl font-bold text-white mb-1 sm:mb-2">Get USDC</h3>
                  <p className="text-sm sm:text-base text-gray-400 mb-3">
                    Trove Markets uses USDC as collateral. Buy USDC on any major exchange (Coinbase, Binance, Kraken) and withdraw to your wallet on Arbitrum network.
                  </p>
                  <div className="flex flex-wrap gap-2">
                    <span className="px-2 py-1 bg-gray-800 text-gray-300 text-xs rounded-lg">Coinbase</span>
                    <span className="px-2 py-1 bg-gray-800 text-gray-300 text-xs rounded-lg">Binance</span>
                    <span className="px-2 py-1 bg-gray-800 text-gray-300 text-xs rounded-lg">Kraken</span>
                    <span className="px-2 py-1 bg-gray-800 text-gray-300 text-xs rounded-lg">P2P</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-900 border-2 border-yellow-500/30 rounded-2xl p-4 sm:p-6">
              <div className="flex items-start gap-3 sm:gap-6">
                ...
                <div>
                  <h3 className="text-base sm:text-xl font-bold text-white mb-1 sm:mb-2">Connect to Trove Markets</h3>
                  <p className="text-sm sm:text-base text-gray-400 mb-3">
                    Visit Trove Markets and connect your wallet. No signup or KYC required - just click &ldquo;Connect Wallet&rdquo; and approve the connection.
                  </p>
                  <a
                    href={TROVE_REFERRAL_URL}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 text-yellow-400 hover:text-yellow-300 font-medium text-sm sm:text-base"
                  >
                    Go to Trove Markets
            ...
            <div className="bg-gray-900 border-2 border-yellow-500/30 rounded-2xl p-4 sm:p-6">
              <div className="flex items-start gap-3 sm:gap-6">
                ...
                <div>
                  <h3 className="text-base sm:text-xl font-bold text-white mb-1 sm:mb-2">Deposit and Trade POKE</h3>
                  <p className="text-sm sm:text-base text-gray-400 mb-3">
                    Deposit USDC as collateral, find the POKE market, choose your position size and leverage (up to 5x), then go long or short on Pokemon cards.
                  </p>
                  <div className="grid grid-cols-2 gap-2 sm:gap-3">
                    <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-2 sm:p-3 text-center">
                      <div className="text-green-400 font-bold text-sm sm:text-base">Long</div>
                      <div className="text-xs text-gray-400">Profit if prices rise</div>
                    </div>
                    <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-2 sm:p-3 text-center">
                      <div className="text-red-400 font-bold text-sm sm:text-base">Short</div>
                      <div className="text-xs text-gray-400">Profit if prices fall</div>
                    </div>
                  </div>
                </div>
              </div>
