...
import { translations, popularStocks, nativeLang, nativeName, isRTL } from '@/data/translations/tunisia';
...
export default function TradeUSStocksFromTunisia() {
