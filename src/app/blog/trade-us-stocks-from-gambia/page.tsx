...
import { translations, popularStocks } from '@/data/translations/gambia';
...
export default function TradeUSStocksFromGambia() {
    ...
    <div className="min-h-screen bg-gray-950">
                ...
                <div className="px-6 pb-6 border-t border-gray-800 pt-6">
                  ...
                  <div className="grid md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4">
                      <h4 className="text-blue-400 font-semibold mb-2">{t.qmoney.title}</h4>
                      <p className="text-gray-400 text-sm mb-3">{t.qmoney.desc}</p>
                      <ol className="text-xs text-gray-300 space-y-1">
                        {t.qmoney.steps.map((step, i) => (
                          <li key={i}>{i + 1}. {step}</li>
                        ))}
                      </ol>
                    </div>
                    ...
                    <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
                      <h4 className="text-green-400 font-semibold mb-2">{t.afrimoney.title}</h4>
                      <p className="text-gray-400 text-sm mb-3">{t.afrimoney.desc}</p>
                      <ol className="text-xs text-gray-300 space-y-1">
                        {t.afrimoney.steps.map((step, i) => (
                          <li key={i}>{i + 1}. {step}</li>
                        ))}
                      </ol>
                    </div>
      ...
      <section className="py-16 px-4 bg-gray-900/50">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Gambia Guides Section */}
          <div className="mt-12 bg-gradient-to-r from-red-500/10 to-green-500/10 border border-red-500/20 rounded-2xl p-6">
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-red-500/20 to-green-500/20 border border-red-500/30 rounded-2xl p-8 text-center">
            <h2 className="text-3xl font-bold text-white mb-4">
              {t.ctaTitle}
            </h2>
